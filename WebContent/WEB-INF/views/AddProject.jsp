...
<body>
    <div class="container">
        <div class="form-container">
            <h2>Add Project</h2>
            <form action="saveproject" method="get">
                ...
                <div class="mb-3">
                    <label for="proj_ludate" class="form-label">Last Updated:</label>
                    <input type="date" id="proj_ludate" name="proj_ludate" class="form-control">
                </div>
